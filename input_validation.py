...
ALIASES = {
    "term": ["Term", "term", "pathway", "Pathway", "name", "Name", "Description", "Gene_set", "gene_set"],
    "genes": ["Genes", "genes", "overlap_genes", "gene_list", "Genes;", "leadingEdge", "leading_edge", "core_enrichment"],
    "padj": ["Adjusted.P.value", "Adjusted P-value", "Adjusted.P-val", "FDR", "qvalue", "q_value", "padj", "adj_p", "Adjusted P-value"],
...
def validate_enrichment_df(df: pd.DataFrame, *, max_rows: int = 25000) -> Dict[str, Any]:
    ...
    return {
        ...
        "warnings": warnings,
        "accepted_formats": ["Enrichr-like", "clusterProfiler-like", "GSEA-like with term/gene/FDR columns"],
